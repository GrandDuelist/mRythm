...
plt.savefig("2-plots/2-traveltime-week/0-week-day-end-line.pdf", bbox_inches='tight')
...
#ax.set_ylim((0,1))
#plt.legend(loc=0,fontsize=15,mode='expand',borderaxespad=0,ncol=3,bbox_to_anchor=(0,1.14,1,.106))
plt.savefig("2-plots2-traveltime-week/0-week-day-end-box.pdf", bbox_inches='tight')
